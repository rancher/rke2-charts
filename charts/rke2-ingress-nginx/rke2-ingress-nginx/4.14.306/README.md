...
![Version: 4.14.306](https://img.shields.io/badge/Version-4.14.306-informational?style=flat-square) ![AppVersion: 1.14.3](https://img.shields.io/badge/AppVersion-1.14.3-informational?style=flat-square)
...
| controller.admissionWebhooks.patch.image.repository | string | `"rancher/kube-webhook-certgen"` |  |
...
| controller.admissionWebhooks.service.ipFamilyPolicy | string | `"PreferDualStack"` |  |
...
| controller.containerName | string | `"rke2-ingress-nginx-controller"` | Configures the controller container name |
...
| controller.dnsPolicy | string | `"ClusterFirstWithHostNet"` | DNS policy for the controller pod. Set to 'ClusterFirstWithHostNet' for RKE2 DaemonSet deployments using hostPort. Ref: https://kubernetes.io/docs/concepts/services-networking/dns-pod-service/#pod-s-dns-policy |
...
| controller.hostPort.enabled | bool | `true` | Enable 'hostPort' or not |
| controller.hostPort.ports.http | int | `80` | 'hostPort' http port |
| controller.hostPort.ports.https | int | `443` | 'hostPort' https port |
| controller.hostname | object | `{}` | Optionally customize the pod hostname. |
| controller.image.allowPrivilegeEscalation | bool | `false` |  |
| controller.image.chroot | bool | `false` |  |
| controller.image.primeTag | string | `"v1.14.3-prime5"` | Image tag used when global.prime.enabled is true (Rancher Prime image variant). |
| controller.image.readOnlyRootFilesystem | bool | `false` |  |
| controller.image.repository | string | `"rancher/nginx-ingress-controller"` |  |
...
| controller.image.tag | string | `"v1.14.3-hardened3"` |  |
...
| controller.kind | string | `"DaemonSet"` | Use a `DaemonSet` or `Deployment` |
...
| controller.publishService | object | `{"enabled":false,"pathOverride":""}` | Allows customization of the source of the IP address or FQDN to report in the ingress status field. By default, it reads the information provided by the service. If disable, the status field reports the IP address of the node or nodes where an ingress controller pod is running. |
| controller.publishService.enabled | bool | `false` | Enable 'publishService' or not |
...
| controller.service.enabled | bool | `false` | Enable controller services or not. This does not influence the creation of either the admission webhook or the metrics service. |
...
| defaultBackend.image.repository | string | `"rancher/nginx-ingress-controller-defaultbackend"` |  |
| defaultBackend.image.runAsGroup | int | `65534` |  |
| defaultBackend.image.runAsNonRoot | bool | `true` |  |
| defaultBackend.image.runAsUser | int | `65534` |  |
| defaultBackend.image.seccompProfile.type | string | `"RuntimeDefault"` |  |
| defaultBackend.image.tag | string | `"1.5-rancher1"` |  |
...
| global.prime.enabled | bool | `false` | Enable Rancher Prime image variant (uses controller.image.primeTag instead of controller.image.tag). |
| global.systemDefaultIngressClass | string | `""` | Rancher system default ingress class override. |
| global.systemDefaultRegistry | string | `""` | Rancher system default registry override. When set, overrides the registry for all images. |
